						    ...
						    <div class="app-card-body">
							    <form class="settings-form" method="post" action="/admin/admin/{{$admin->id}}/update">
                                    ...
                                    <div class="mb-3">
									    ...
									    <input type="password" class="form-control"  placeholder="Enter Password"  id="setting-input-3" name="password" required>
									</div>
                                    ...
                                    <div class="mb-3">
									    ...
									    <input type="password" class="form-control"  placeholder="Password Confirmation"  id="setting-input-4" name="password_confirmation" required>
									</div>
